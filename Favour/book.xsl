	...
	<html>
		...
		<body>
			...
			<section>
							...
							<div style="display: none;" class="book_description" id="book_description1">
								...
								<div class="content">
									...
									<div class="quantity_block">
										...
										<button class="add_to_cart" onclick="updateCart(card1, quantity1, bookQuantity1)">Add to cart</button>
									</div>
				...
				<div style="display: none;" class="cart" id="cart">
					...
					<!-- <p>1</p> -->
					<div class="cardbox">
						<div style="display: flex" class="card" id="card1">
							<div>
								<p>1984</p>
							</div>
						
							<div class="order_info">
								<p id="bookPrice1">10.99</p>
								<button id="cartAdd" onclick="calculateQuantity(1, bookQuantity1, card1)">+</button>
								<p id="bookQuantity1">0</p>
								<button id="cartSub" onclick="calculateQuantity(-1, bookQuantity1, card1)">-</button>
							</div>
